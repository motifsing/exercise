...
public class CountryCodeConnectMapKeyedBroadCast {
    ...
    public static void main(String[] args) throws Exception {
        ...
        BroadcastConnectedStream<MyKafkaRecord, Map<String, String>> connect = kafkaKeyedStream.connect(broadcast);

        SingleOutputStreamOperator<String> process = connect.process(new KeyedBroadcastProcessFunction<String, MyKafkaRecord, Map<String, String>, String>() {
            @Override
